...
trait MockUnignoreBenefitConnector extends MockFactory {
  ...
  object MockUnignoreBenefitConnector {
    ...
    def unignoreBenefit(request: Def1_IgnoreBenefitRequestData): CallHandler[Future[DownstreamOutcome[Unit]]] = {
      (mockUnignoreBenefitConnector
        .unignoreBenefit(_: Def1_IgnoreBenefitRequestData)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(request, *, *, *)
    }
