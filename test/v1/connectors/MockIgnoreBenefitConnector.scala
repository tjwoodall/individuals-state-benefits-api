...
trait MockIgnoreBenefitConnector extends MockFactory {
  ...
  object MockIgnoreBenefitConnector {
    ...
    def ignoreBenefit(request: IgnoreBenefitRequestData): CallHandler[Future[DownstreamOutcome[Unit]]] = {
      (mockIgnoreBenefitConnector
        .ignoreBenefit(_: IgnoreBenefitRequestData)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(request, *, *, *)
    }
